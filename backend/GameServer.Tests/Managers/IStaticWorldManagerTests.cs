...
namespace GameServer.Tests.Managers
{
    ...
    public class IStaticWorldManagerTests
    {
        ...
        public void GetObjectAt_ShouldReturnObject_WhenObjectExists()
        {
            ...
            var expectedObject = new StaticObject(1, position, "Tree", "tree.png", isPassable: false);
        ...
        public void GetObjectsInArea_ShouldReturnOnlyObjectsInArea()
        {
            ...
            var obj1 = new StaticObject(1, new Position(5, 5), "Tree1", "tree.png");
            var obj2 = new StaticObject(2, new Position(15, 15), "Tree2", "tree.png"); // fora da área
            var obj3 = new StaticObject(3, new Position(3, 3), "Tree3", "tree.png");
        ...
        {
            // Arrange
            var obj = new StaticObject(1, new Position(5, 5), "Tree", "tree.png");
