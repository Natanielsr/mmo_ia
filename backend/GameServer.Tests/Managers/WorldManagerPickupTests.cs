...
namespace GameServer.Tests.Managers
{
    public class WorldManagerPickupTests
    {
        ...
        public void Pickup_Does_Not_Auto_Heal_Player()
        {
            ...
            var potion = new HealingItem("p1", "Healing Potion", 0.1f, "healing-potion", new Position(1, 0), ItemType.Potion);
        ...
        {
            var player  = new Player(1, "Hero", new Position(0, 0));
            var potion1 = new HealingItem("p1", "Healing Potion", 0.1f, "healing-potion", new Position(1, 0), ItemType.Potion);
            var potion2 = new HealingItem("p2", "Healing Potion", 0.1f, "healing-potion", new Position(1, 0), ItemType.Potion);
        ...
        public void UseItem_From_Inventory_Heals_Player()
        {
            ...
            var potion = new HealingItem("p1", "Healing Potion", 0.1f, "healing-potion", pos, ItemType.Potion);
