...
namespace GameServer.Tests.Items
{
    public class WeaponArmorTests
    {
        ...
        {
            var weapon = new Weapon("w1", "Iron Sword", 1.5f, Pos, attackBonus: 8);
        ...
        {
            var weapon = new Weapon("w1", "Wooden Stick", 0.5f, Pos, attackBonus: 0);
        ...
        {
            var weapon = new Weapon("w99", "Steel Axe", 3.0f, Pos, attackBonus: 12);
        ...
        {
            var armor = new Armor("a1", "Iron Helmet", 1.8f, Pos, defenseBonus: 5);
        ...
        {
            var armor = new Armor("a1", "Cloth Robe", 0.3f, Pos, defenseBonus: 0);
        ...
        {
            var armor = new Armor("a99", "Full Plate", 10f, Pos, defenseBonus: 20);
